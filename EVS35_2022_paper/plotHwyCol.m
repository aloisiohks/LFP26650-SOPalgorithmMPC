...
data0 = load('SOP_HwyCol_1e6.mat');
data1 = load('SOP_HwyCol_1e7.mat');
data2 = load('SOP_HwyCol_1e8.mat');
data3 = load('SOP_HwyCol_1e9.mat');
data4 = load('SOP_HwyCol_adap.mat');
...
thesisFormat;
if saveFig, saveas(gcf,sprintf('./figures/SOP_HwyCol'),'epsc'); end

if flagPlot==0

    tp = 1:10;
    figure()
    plot(tp,data1.I_MPC_Dis(1,2:end,tk),'-o','linewidth',2,'Color',colors{1});hold on;
    ...
    figure()
    plot(tp,data1.V_MPC_Dis(1,2:end,tk),'-o','linewidth',2,'Color',colors{1});hold on;
...
% 
    ...
    xlabel(['Prediction interval',newline,'\bf (e)']); 
    set(gcf,'position',[400,400,226,196]); 
    paperSmallFormat;
    set(get(gca,'XLabel'),'FontSize',15,'FontName','Times','FontWeight','normal');
    set(get(gca,'YLabel'),'FontSize',15,'FontName','Times','FontWeight','normal');
    ...
    figure()
    plot(tp,data4.Ru_MPC_Dis(tk,2:end),'-o','linewidth',2,'color',[0.4660, 0.6740, 0.1880]);hold on;
    grid on;xlim([1 tp(end)]);ylabel('{\it r_{adap}}')
    xlabel(['Prediction interval',newline,'\bf (f)']);
    set(gcf,'position',[400,400,226,196]);  
    paperSmallFormat;
    set(get(gca,'XLabel'),'FontSize',15,'FontName','Times','FontWeight','normal');
    set(get(gca,'YLabel'),'FontSize',15,'FontName','Times','FontWeight','normal');
...
elseif flagPlot == 1
    ...
    tp = 1:10;
    figure()
    plot(tp,data1.I_MPC_Chg(1,2:end,tk),'-o','linewidth',2,'Color',colors{1});hold on;
    ...
    figure()
    plot(tp,data1.V_MPC_Chg(1,2:end,tk),'-o','linewidth',2,'Color',colors{1});hold on;
...
% 
    ...
    figure()
    plot(tp,data4.Ru_MPC_Chg(tk,2:end),'-o','linewidth',2,'color',[0.4660, 0.6740, 0.1880]);hold on;
    grid on;xlim([1 tp(end)]);ylabel('{\it r_{adap}}')
    xlabel(['Prediction interval']);
    set(gcf,'position',[400,400,226,196]);  
    paperSmallFormat;
