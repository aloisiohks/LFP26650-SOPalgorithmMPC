...
data0 = load('SOP_NYCC_1e6.mat');
data1 = load('SOP_NYCC_1e7.mat');
data2 = load('SOP_NYCC_1e8.mat');
data3 = load('SOP_NYCC_1e9.mat');
data4 = load('SOP_NYCC_adap.mat');
...
thesisFormat;
if saveFig, saveas(gcf,sprintf('./figures/SOP_NYCC'),'epsc'); end
