...
set(gcf,'color','w');
paperSmallFormat;
if saveFig, saveas(gcf,sprintf('./figures/SOC_NYCC_SPKF.png'),'epsc'); end
...
xlabel ('Time (s)');
paperSmallFormat;
if saveFig, saveas(gcf,sprintf('./figures/Temp_NYCC_SPKF.png'),'epsc'); end
...
xlim([0 time(end)]);
paperSmallFormat;
if saveFig, saveas(gcf,sprintf('./figures/voltage_NYCC.png'),'epsc'); end
...
paperSmallFormat;
grid on;
if saveFig, saveas(gcf,sprintf('./figures/current_NYCC.png'),'epsc'); end
