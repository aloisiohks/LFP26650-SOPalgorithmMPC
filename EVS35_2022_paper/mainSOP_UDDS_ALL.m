...
load('Dataset1.mat'); % loads data


adap = [0 0 0 0 1];
ru = [1e-6 1e-7 1e-8 1e-9 1e-1];
saveName1 = 'results/SOP_UDDS_';
...
Tc0 = 34;      % Tc initial guess
Ts0 = 34;      % Ts initial guess
% Covariance values
SigmaX0 = diag([0.5e-2 1e-4 .5e-2 1e-1 1e-1]); % uncertainty of initial state
