...
data0 = load('SOP_FSAE_1e6.mat');
data1 = load('SOP_FSAE_1e7.mat');
data2 = load('SOP_FSAE_1e8.mat');
data3 = load('SOP_FSAE_1e9.mat');
data4 = load('SOP_FSAE_adap.mat');
...
% legend('{\it r_w}=10^{-6}','{\it r_w}=10^{-7}','{\it r_w}=10^{-8}','{\it r_w}=10^{-9}','{{\it r_{adap}}}',...
...
xlim([0 length(data0.P_MPC_Dis)]);
thesisFormat;
if saveFig, saveas(gcf,sprintf('./figures/SOP_FSAE'),'epsc'); end
...
% 
    ...
    xlabel(['Prediction interval']); 
    set(gcf,'position',[400,400,226,196]); 
     legend('SMPC1','SMPC2','SMPC3','SMPC4','SAMPC','NumColumns',2,'Location','North');
    paperSmallFormat;
    set(get(gca,'XLabel'),'FontSize',15,'FontName','Times','FontWeight','normal');
    set(get(gca,'YLabel'),'FontSize',15,'FontName','Times','FontWeight','normal');
...
elseif flagPlot == 1
    ...
    set(get(gca,'YLabel'),'FontSize',15,'FontName','Times','FontWeight','normal');
    set(gcf,'position',[400,400,226,196]);  
           legend('SMPC1','SMPC2','SMPC3','SMPC4','SAMPC','NumColumns',1,'Location','Southeast');
    paperSmallFormat;
