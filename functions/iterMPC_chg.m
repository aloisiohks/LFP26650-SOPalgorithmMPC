...
function [Y,X,U,DelU,Pavg,Pinst,mpcData] = iterMPC_chg(xk_1,mpcData,Nsim,deltaT)
    ...
    mpcData.uk_1 = uk;
    du_max = abs(mpcData.const.u_max);
...
if ((xk_1(1) < mpcData.const.z_max) && (xk_1(4) < (mpcData.const.tc_max )) )
   ...
   [M,gamma] = constraints(dx,linMatrices,mpcData,u,'charge');
